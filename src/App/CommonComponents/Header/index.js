          ...
          <div className={`navbar--collapse ${(this.state.isExpanded) ? 'navbar--collapse--false' : 'navbar--collapse--true' }`}>
            <ul className="navbar__ul">
              <li className="nav-item navbar__ul_li">
                <NavLink activeClassName="active-navbar-link main" className="nav-main-link mr" to='/' exact={true} >Home</NavLink>
...
{/* ***********start of new div********************** */}
              ...
              <li className="nav-item navbar__ul_li">
                ...
                <div className="nav-dropdown-menu">
                  ...
                  <NavLink activeClassName="active-navbar-link" className="nav-main-link" to="/ShoppingCart">Shopping Cart</NavLink>
                  {/* <NavLink activeClassName="active-navbar-link"className="nav-main-link" to='/checkout'>Checkout</NavLink> */}
                </div>
              </li>

              <li className="nav-item navbar__ul_li">
                <NavLink activeClassName="active-navbar-link main" className="nav-main-link" to="/schedule">Schedule</NavLink>
              </li>
              ...
              <li className="nav-item navbar__ul_li">
                <div className="nav-menu-icon-div">
                  ...
                  <NavLink activeClassName="active-navbar-link" className="nav-main-link icon" to='/ShoppingCart'><i className="fas fa-shopping-cart"></i></NavLink>
